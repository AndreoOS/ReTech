...
{
    public partial class LastCrate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "character varying(4095)", maxLength: 4095, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Total = table.Column<decimal>(type: "numeric", nullable: false),
                    ShippingAddress = table.Column<string>(type: "character varying(4095)", maxLength: 4095, nullable: true),
                    Status = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Color = table.Column<string>(type: "character varying(63)", maxLength: 63, nullable: false),
                    Size = table.Column<string>(type: "character varying(63)", maxLength: 63, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductBrand", x => new { x.Id, x.ProductId, x.BrandId });
                    table.ForeignKey(
